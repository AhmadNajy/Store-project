...
<style>
    ...
    <div class="container marketing">
        <div >
            <br>
            <h4 for="descriptionFormControlTextarea1" class="form-label"> إختار صنف لعرض منتجاته:    </h4>

            <form class="selectForm" action="{{url('selectCaregory')}}" method="post">
                @csrf
                @method('patch')
                <select class="form-select custamSelect" name="selected_category" id="vategory">
